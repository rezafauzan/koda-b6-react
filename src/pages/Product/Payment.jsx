                        ...
                        <div className="flex-1 flex flex-col gap-4 w-full">
                            ...
                            <div className="flex flex-col gap-4 items-center justify-center">
                                <div className="flex-1 flex flex-col gap-4">
                                    <div className="w-full flex rounded overflow-hidden bg-gray-100 px-4">
                                        {/* {(flashsale ? : '')} */}
                                        <div className="overflow-hidden flex-1 h-full">
                                            <img src="https://placehold.co/1024x1024" alt="Product_Name" className="h-full" />
                                        </div>
                                        <div className="h-fit flex flex-col gap-4 left-4 right-4 bottom-0 p-4 rounded flex-3 relative">
                                            ...
                                            <button className="absolute flex justify-center items-center top-[50%] right-4 bottom-[50%] h-10 w-10 cursor-pointer"><CgCloseO className="h-10 w-10 text-red-700" /></button>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex-1 flex flex-col gap-4">
