            ...
            <div className="container flex flex-col justify-center gap-4 p-4 flex-3 text-(--color-secondary)">
                <form className="flex flex-col justify-center gap-4 p-4 flex-3">
                    ...
                    <div className="flex justify-between gap-4 social-login">
                        <button className="flex items-center justify-center flex-1 p-4 bg-white rounded shadow-lg cursor-pointer"><img src={facebook_logo} alt="Facebook_Login_Icon" /></button>
                        <button className="flex items-center justify-center flex-1 p-4 bg-white rounded shadow-lg cursor-pointer"><img src={google_logo} alt="Google_Login_Icon" /></button>
                    </div>
                </form>
            </div>
        </Section>
