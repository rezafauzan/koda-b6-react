    ...
    function login({ email, password }) {
        ...
        if (userFound) {
            if (password === userFound.password) {
                window.localStorage.setItem("user", JSON.stringify({ fullname: userFound.fullname, avatar: userFound.avatar, email: userFound.email, phone: userFound.phone, role: userFound.role }))
