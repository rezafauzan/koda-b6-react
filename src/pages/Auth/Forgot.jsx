...
const ForgotPassword = () => {
    ...
    async function forgot({ email, code_OTP, password, confirm_password }) {
        if (!email || !code_OTP || !password || !confirm_password) {
                    ...
                    <div className="flex w-full flex-col justify-center gap-4 p-4 flex-3" onSubmit={handleSubmit(forgot)}>
                        ...
                        <form className="flex flex-col justify-center gap-4" onSubmit={handleSubmit(requestOTP)}>
                            ...
                            <div className="flex items-center gap-4">
                                <button onClick={requestOTP} className="bg-(--color-primary) text-black p-4 rounded cursor-pointer">Request OTP</button>
                            </div>
                        </form>
